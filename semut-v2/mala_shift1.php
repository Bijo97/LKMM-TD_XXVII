...
<html lang="en">
  <head>
    ...
    <title>Untuk seluruh Mahasiswa Lama Shift 1 | LKMM-TD XXVII - The Extraordinary Worker</title>
  ...
  <body style="overflow-x:hidden;">
    <div class="container-fluid">
      ...
      <div class="row">
        <center><h3>UNTUK SELURUH MAHASISWA LAMA SHIFT 1</h3></center><br><br>
        <div class="col-md-10 col-md-offset-1">
          <center><p><b>Seluruh mahasiswa lama pada shift 1 mengikuti jadwal shift 1A.</b><br> Terima kasih.</p></center>
        </div>
      </div>
    </div>
