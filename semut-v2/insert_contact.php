...
// $response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6LdFhyATAAAAAF2A6B8rm4wgRPOsQ5mmCGOze-LD&response=".$captcha."&remoteip=".$_SERVER['REMOTE_ADDR']);
...
// {
  ...
  mysql_query("INSERT INTO contact VALUES('', '$nrp', '$nama', '$email', '$nohp', '$subject', '$pesan', 0, '$dats')");
  ...
  // $mail->Body = $f;
  // $mail->send();
  header("location: contact.php?status=3");
//}
?>