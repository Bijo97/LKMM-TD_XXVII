...
include "connect.php";
$ambil_data = mysql_query("select * from news order by ID_News desc limit $offset, $dataPerPage",$koneksi);
$hitung_record = mysql_query("SELECT COUNT(*) AS jumData FROM news",$koneksi);
...
?>
	<div class="row-fluid">
      ...
      <div class="span8">
          ...
          <p>
          	<a href="index.php?link=lihatDetailBerita.php&id=<?=$hasil_data['ID_News'];?>" class="btn btn-primary">Baca Selengkapnya</a> 
          	<a href="#" class="btn btn-inverse">Diposkan pada <?=$hasil_data['time'];?></a>
          </p>
      </div>      
    </div>
    <hr>
...
<div class="pagination pagination-centered">
    <ul>
	<?php
		$link = "indexberita.php?link=lihatBerita.php&hal=";
