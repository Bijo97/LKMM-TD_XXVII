<?php
extract($_POST);
$con=mysqli_connect('lkmm-td.petra.ac.id','lkmmtd','kapokmukapan','lkmmtd_database');
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Web Berita</b></span>
                </a>
            ...
            ?>
                ...
                <footer class="main-footer">
                    ...
                    <strong>Copyright &copy; 2016<a href="http://lkmm-td.petra.ac.id"> LKMM-TD XVII </a>.</strong> All rights reserved.
                </footer>
