   ...
   <?php if ($cektime >= 7 && $cektime < 18){ ?>
     ...
     <div class="cloud small cloud-4">
      ...
      <div class="row" id="news" >
        ...
        <div id="dialog" title="PENGUMUMAN PENTING!" style="display: none; z-index: 20 !important;">
            ...
            <div class="container-fluid">
              <!-- <form>
                <div class="form-group">
                  ...
                  <input name="nrpmyboard" type="number" class="form-control" placeholder="NRP" required>
                </div>
                <div class="form-group">
                  <label for="inputNRP">Password: </label>
                  <input name="passmyboard" type="password" class="form-control" placeholder="Password" required>
                </div>
                <div class="form-group">
                 <button type="submit" class="btn btn-primary pull-right" id="submitMyboard" disabled>Submit</button>
                </div>
              </form> -->
...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  <script>
  $( function() {
    $( "#dialog" ).dialog({my: "center top", at: "center bottom+200", of: "#news"});
  } );
  </script>
<script>
