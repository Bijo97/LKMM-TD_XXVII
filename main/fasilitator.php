...
<?php
    ...
    $sql2 = "SELECT * FROM sesi WHERE hari = ".$hari;
    $result2 = mysql_query($sql2);

    $sql3 = "SELECT * FROM sesi WHERE hari = ".$hari;
...
<table class="table table-striped" border="3">
    ...
    <?php
        ...
        while ($row11 = mysql_fetch_array($result11)){
            $sql12 = "SELECT * FROM sesi WHERE hari = ".$hari;
  ...
  <form method="post" action="updatevalidate.php">
    <div class="col-sm-10">
